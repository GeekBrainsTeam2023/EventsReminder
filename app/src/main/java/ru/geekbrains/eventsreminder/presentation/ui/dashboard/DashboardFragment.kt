...
class DashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val event1 = Event(2, "Holiday", "ic_notification_add_24.xml", "08.03", "3 days")
        val event2 = Event(3, "Svetlana", "ic_notification_add_24", "11.06.2003", "10 days")
        val event3 =
            Event(4, "Visit to my dantist", "ic_notification_add_24.xml", "27.01.2020", "today")
